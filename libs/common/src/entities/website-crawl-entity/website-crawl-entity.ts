...
export class WebsiteCrawlEntity
{
    ...
    constructor(id: number, url: string, title: string, outgoingUrls: Array<string>, websiteRecordId: number, crawlTime: Date)
    {
        this.id = id;
        this.url = url;
        this.title = title;
    ...
    {
        const websiteCrawlEntity: WebsiteCrawlEntity = 
            new WebsiteCrawlEntity(null, model.url, model.title, model.links, model.startingNodeId, model.crawlTime);
